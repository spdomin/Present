...
\begin{twentyshort}
	...
	\twentyitemshort{2018}{Domino, S. P., \textit{Multi-phase use cases within the abnormal thermal environment}, Invoted PSAAP-2 Multi-phase Workshop.}
...
\begin{twentyshort}
	...
	\twentyitemshort{2023}{Teaching Me469, Stanford Mechanical Engineering Departments Graduate class, \textit{Computational Methods for Fluid Dynamics}.}
...
\begin{twentyshort} 
	...
	\twentyitemshort{2022}{Benjamin, M., Domino, S. P., Iaccarino, G, \textit{Challenges in the use of neural networks for large–eddy simulations.The suitability of hybrid meshes for low-Mach large-eddy simulation}, Annual CTR Research Briefs.}
