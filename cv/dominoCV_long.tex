...
\begin{twentyshort} % Environment for a short list with no descriptions
	\twentyitemshort{Sandia}{Computational Scientist; Engineering Sciences, Computational Thermal and Fluid Mechanics (1541); Distinguished 
...
\twentyitemshort{2021} {Barone, M., Ray, J., Domino, S. P., \textit{Feature selection, clustering, and prototype placement for turbulence datasets"}, AIAA J., https://doi.org/10.2514/1.J060919.}
...
of atypical, e.g., fire, wind and wave-energy, computational ethology, etc., multi-physics applications. Mentoring, 
...
\begin{twenty} % Environment for a list with descriptions
   ...
   \twentyitem{2021-now}{Adjunct Professor} {Stanford/ICME} {Co-teaching responsibilities for Stanford's ME469 Mechanical Engineering graduate Computational 
   ...
   \twentyitem{2005-now}{Member of the Technical Staff} {Sandia National Laboratories} {My experience at Sandia rests within low-Mach 
...
\begin{twentyshort} % Environment for a short list with no descriptions
  \twentyitemshort{2021-now}{\textit{Developing credible high-fidelity mod/sim tools for wave energy converter design}. Development of implicit overset methods coupled to six-DOF and volume of fluid transport. }
  ...
  \twentyitemshort{2012-2015}{\textit{Computer Science Advanced Research: Core Computational Methodologies}. Duties as 
a portfolio manager for a multi-discipline Advanced Simulation and Computing (Research Foundations) included
making funding decisions (\$1.25 million per year) and technical oversight. Projects ranged from advanced 
methods of algebraic multigrid, to the development of Helmholtz solvers.}
...
\section{Noteworthy Publications/Book Chapters}

\begin{twentyshort} % Environment for a short list with no descriptions
  \twentyitemshort{2022}{Hubbard, J., Hansen, M., Kirsch, J., Hewson, J., Domino, S. P.,
    \textit{Medium scale methanol pool fire model validation},
    J. Heat Transfer, 144(6), 2022.}
   ...
   \twentyitemshort{2016}{Safta, C., Blaylock, M., Templeton, J., Domino, S. P., Sargsyan, K., Najm, H.,
    \textit{Uncertainty quantification in LES of channel flow},
    Int. J. Numer. Method. Fluids, 83 (4).}
  ...
  \twentyitemshort{2000}{Domino, S. P., Smith, P. J.,
    \textit{State space sensitivity to a prescribed probability density function shape in coal 
      combustion systems: Joint $\beta$-PDF versus clipped Gaussian PDF}, Proc. Combust. Inst., 28 (2).}
\end{twentyshort}
...
\begin{twentyshort} % Environment for a short list with no descriptions
  \twentyitemshort{2018}{Domino, S. P., Jofre, L., Iaccarino, G, \textit{The suitability of hybrid meshes for low-Mach large-eddy simulation}, Proceedings of the CTR Summer Program.}
  \twentyitemshort{2018}{Jofre, L., Domino, S. P., Iaccarino, G, \textit{Characterization of structural uncertainty in LES of a round jet}, Annual CTR Research Briefs.}
  \twentyitemshort{2016}{Domino, S. P., Jofre, L., Iaccarino, G, \textit{Exploring model-form uncertainties in large-eddy simulation}, Proceedings of the CTR Summer Program.}
  \twentyitemshort{2016}{Jofre, L., Domino, S. P., Iaccarino, G, \textit{A framework for estimating uncertainty in LES closures}, Annual CTR Research Briefs.}
  \twentyitemshort{2014}{Domino, S. P., \textit{A comparison between low-order and higher-order low-Mach discretization approaches}, Proceedings of the CTR Summer Program.}
  \twentyitemshort{2010}{Domino, S. P., \textit{Towards verification of sliding mesh algorithms for complex applications using MMS}, Proceedings of the CTR Summer Program.}
  \twentyitemshort{2008}{Domino, S. P., \textit{A comparison of various equal-order interpolation methodologies using the method of manufactured solutions}, Proceedings of the CTR Summer Program.}
  \twentyitemshort{2006}{Domino, S. P., \textit{Toward verification of formal time accuracy for a family of approximate projection methods using the method of manufactured solutions}, Proceedings of the CTR Summer Program.}
\end{twentyshort}
...
\begin{twentyshort} % Environment for a short list with no descriptions
  ...
  \twentyitemshort{2002}{Domino, S. P., DesJardin, P., Suo-Antilla, J., \textit{Development of a smoke 
transport model to enhance the certification process for cargo bay smoke detection systems}, Fire Safety Science Proceedings of the Seventh International Symposium.}
\end{twentyshort}
...
\begin{twentyshort} % Environment for a short list with no descriptions
  \twentyitemshort{2019}{Domino, S. P., Ananthan, S., Knaus, R., Williams, A., \textit{Deploying Nalu/Kokos algorithmic 
infrastructure with performance benchmarking}, Sandia National Laboratories, Sandia Report SAND2017-10549R.}
  \twentyitemshort{2019}{Domino, S. P., Williams, A., \textit{Nalu's linear system assembly using T-Petra}, Sandia 
National Laboratories, Sandia Report SAND2019-0120.}
  \twentyitemshort{2018}{Domino, S. P., Thomas, S., Barone, M., et al., \textit{Deploying production sliding mesh 
capability with linear solver benchmarking}, Sandia National Laboratories, Sandia Report SAND2018-1807R.}
  \twentyitemshort{2005}{Nicolette, V., Tieszen, S., Black, A., Domino, S. P., O'Hern, T., \textit{A turbulence 
model for buoyant flows based on vorticity generation}, Sandia National Laboratories, Sandia Report SAND2005-6273.}
...
\begin{twentyshort} % Environment for a short list with no descriptions
  ...
  \twentyitemshort{2018}{Domino, S. P., \textit{Multi-phase use cases within the abnormal thermal environment}, PSAAP-2 Multi-phase Workshop.}
  \twentyitemshort{2018}{Domino, S. P., \textit{The suitability of hybrid meshes for low-Mach large-eddy simulation}, Invited Lawrence Livermore National Laboratory CASC Seminar Series.}
  \twentyitemshort{2017}{Domino, S. P., \textit{ECP ExaWind experience in transitioning Nalu to MPI+x}, Invited presentation, PSAAP-2 Review.}
...
\section{In-Preparation Manuscripts/Book Chapters}

\begin{twentyshort} % Environment for a short list with no descriptions
  \twentyitemshort{2022}{Domino, S. P.,
    \textit{Unstructured finite volume techniques for low-Mach large-eddy simulation.}, Invited chapter to appear in 
Moser, R., Numerical Methods in Turbulence Simulation, Elsevier.}
  \twentyitemshort{2022}{Domino, S. P., Wenzel, E.,
    \textit{A Direct Numerical Simulation study for Re$^\tau$~505 non-isothermal jet impingement},
    to be submitted to J. Fluid Mech.}
  \twentyitemshort{2022}{Scott, S., Domino, S. P., \textit{Large-scale pool fire dynamics/attributes for fires in crossflow: 
      exploring flame shape sensitivity to pool shapes}, to be submitted to Flow.}
  \twentyitemshort{2021}{Domino, S. P., Horne, W.,
    \textit{Development and deployment of a credible unstructured, six-DOF, implicit low-Mach overset high-fidelity 
simulation tool for wave energy applications}, submitted to Renewable Energy.}
\end{twentyshort}
