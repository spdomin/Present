...
\begin{twentyshort} % Environment for a short list with no descriptions
	\twentyitemshort{Sandia}{Computational Scientist; Center: Engineering Sciences, Group: Computational Thermal and Fluid Mechanics (1541); Distinguished 
...
simulation tool for wave energy applications}, Accepted, Renewable Energy (in production).}
...
\begin{twenty} % Environment for a list with descriptions
   ...
   \twentyitem{2021-2022}{Adjunct Professor} {Stanford/ICME} {Co-teaching responsibilities for Stanford's ME469 Mechanical Engineering graduate Computational 
...
\begin{twentyshort} % Environment for a short list with no descriptions
  \twentyitemshort{2022}{Hubbard, J., Hansen, M., Kirsch, J., Hewson, J., Domino, S. P., \textit{Medium scale methanol pool fire model validation}, J. Heat Transfer, 144(6), 2022.}
...
\begin{twentyshort} % Environment for a short list with no descriptions
 ...
 \twentyitemshort{2022}{Domino, S. P.,
    \textit{Unstructured finite volume approaches for turbulence.}, In:  Moser, R., Numerical Methods in Turbulence Simulation, Elsevier. (in production)}
