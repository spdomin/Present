...
%
% Modified by:
% Stefan P. Domino with retension of the MIT LICENSE
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
models; Eldred, Ng, Domino, and Barone; Handbook of UQ}
	\twentyitemshort{2014}{Towards extreme-scale simulations for low-Mach fluids with second-generation 
Trilinos; Lin et. al; Parallel Processing Letters}
\end{twentyshort}
...
\begin{twentyshort} % Environment for a short list with no descriptions
	\twentyitemshort{2017}{Sheldon R. Tieszen Engineering Sciences Award for Technical Excellence.}
	\twentyitemshort{2000-2018}{Several Sandia Institutional Achievement awards.}
...
% Skill bar section, each skill must have a value between 0 an 6 (float)
\favthings{{Ocean/5.9}, {Science/5.7}, {Pursuit of Knowledge/5.6}, {CFD/5.8}, {Snow/5.2}, {Mountains/5.8}, {Family/6.0}}
...
\section{Noteworthy Experience}

\begin{twentyshort} % Environment for a short list with no descriptions
	\twentyitemshort{2018}{Guest lecturer for Stanford's ME469 Computational Fluid Mechanics.}
	\twentyitemshort{2000-2018}{Supported numerous peer-review processes (journals, DOE panels, etc.).}
\end{twentyshort}

\section{Review}

Dr. Stefan Domino is a computational domain specialist researcher who develops tools and techniques
to support advancement of multi-physics understanding of complex phenomena including fluid mechanics,
