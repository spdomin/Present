...
\begin{twentyshort} % Environment for a short list with no descriptions
	\twentyitemshort{2020}{A Multi-physics computational investigation of droplet pathogen transport emanating 
from synthetic coughs and breathing; Domino, Pierce, Hubbard; Accepted to Atomization and Spray.}
	\twentyitemshort{2019}{Eigensensitivity analysis of subgrid-scale stresses in large-eddy simulation of a turbulent axisymmetric jet; Jofre, Domino, Iaccarino, Int J. Heat Trans.}
...
approach; Domino; J.Comp. Physics, 359 (15).}
...
\begin{twenty} % Environment for a list with descriptions
	\twentyitem{2005-now}{Principal Member of the Technical Staff} {Sandia National Laboratories} {Principal 
...
%	\twentyitem{2005-now}{Principal Member of the Technical Staff} {Sandia National Laboratories} {Principal Investigator for a ASC V&V% and P&EM project structural uncertainty for LES and model development for impinging jets; originator of the open-source 
%Nalu code base; original member of the ExaWind team Office of Science ECP, multi-laboratory, multi-institutional project that is
...
\begin{twentyshort} % Environment for a short list with no descriptions
	\twentyitemshort{2020}{Co-taught Stanford's ME469 Mechanical Engineering Graduate Computational Fluid Mechanics class.}
	...
	\twentyitemshort{2000-2018}{Numerous internal and external peer-review processes supported, e.g., journals, DOE and NSF panels, etc.).}
\end{twentyshort}
